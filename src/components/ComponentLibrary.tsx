              ...
              <Table>
                ...
                <TableBody>
                  {mosfetLibrary.map((mosfet) => (
                    <TableRow key={mosfet.partNumber}>
                      <TableCell className="font-medium">{mosfet.partNumber}</TableCell>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right">Ripple (A)</TableHead>
                ...
                <TableBody>
                  {capacitorLibrary.map((cap) => (
                    <TableRow key={cap.partNumber}>
                      ...
                      <TableCell className="text-right">{cap.rippleCurrent}</TableCell>
